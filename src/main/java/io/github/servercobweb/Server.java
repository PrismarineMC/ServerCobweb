...
import io.github.servercobweb.command.*;
import io.github.servercobweb.event.*;
import io.github.servercobweb.event.server.QueryRegenerateEvent;
import io.github.servercobweb.lang.BaseLang;
import io.github.servercobweb.math.NemisysMath;
import io.github.servercobweb.network.*;
import io.github.servercobweb.network.query.QueryHandler;
import io.github.servercobweb.network.rcon.RCON;
import io.github.servercobweb.plugin.JavaPluginLoader;
import io.github.servercobweb.plugin.Plugin;
import io.github.servercobweb.plugin.PluginLoadOrder;
import io.github.servercobweb.plugin.PluginManager;
import io.github.servercobweb.scheduler.ServerScheduler;
...
public class Server {
    ...
    public Server(MainLogger logger, final String filePath, String dataPath, String pluginPath) {
        ...
        ServerCobweb.DEBUG = this.getPropertyInt("debug", 1);
        if (this.logger instanceof MainLogger) {
            this.logger.setLogDebug(ServerCobweb.DEBUG > 1);
        }
        ...
        this.logger.info(this.getLanguage().translateString("nemisys.server.info", new String[]{this.getName(), TextFormat.YELLOW + this.getServerVersion() + TextFormat.WHITE, TextFormat.AQUA + this.getCodename() + TextFormat.WHITE, this.getApiVersion()}));
        ...
        this.network.registerInterface(new JRakLibInterface(this));
    ...
    public String getMainIp(){
        return this.getPropertyString("main-server", "0.0.0.0:19133").split(":")[0];
    }

    public int getMainPort(){
        return Integer.parseInt(this.getPropertyString("main-server", "0.0.0.0:19133").split(":")[1]);
    }
    ...
    public void start() {
        ...
        this.getLogger().info(this.getLanguage().translateString("nemisys.server.startFinished", Float.toString(Math.round(System.currentTimeMillis() - ServerCobweb.START_TIME) / 1000f)));
    ...
    public String getServerVersion() {
        return ServerCobweb.VERSION;
    }

    public String getCodename() {
        return ServerCobweb.CODENAME;
    }

    public String getVersion() {
        return ServerCobweb.MINECRAFT_VERSION;
    }

    public String getApiVersion() {
        return ServerCobweb.API_VERSION;
    }
    ...
    public String getMotd() {
        return this.getPropertyString("motd", "ServerCobweb server");
    }
