...
import io.github.servercobweb.utils.EventException;
 ...
 * For the way to implement a listener, see: {@link org.itxtech.nemisys.event.Listener}</p>
 *
 * @author Unknown(code) @ Nukkit Project
 * @author 粉鞋大妈(javadoc) @ Nukkit Project
 * @see org.itxtech.nemisys.event.EventHandler
