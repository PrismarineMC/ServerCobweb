...
import io.github.servercobweb.command.CommandExecutor;
import io.github.servercobweb.utils.Config;
 ...
 * <p>
 * <p>对于插件作者，我们建议让插件主类继承{@link org.itxtech.nemisys.plugin.PluginBase}类，而不是实现这个接口。<br>
 * For plugin developers: it's recommended to use {@link org.itxtech.nemisys.plugin.PluginBase} for an actual plugin
 * instead of implement this interface.</p>
 *
 * @author MagicDroidX(code) @ Nukkit Project
 * @author 粉鞋大妈(javadoc) @ Nukkit Project
 * @see org.itxtech.nemisys.plugin.PluginBase
...
public interface Plugin extends CommandExecutor {
     ...
     * <p>
     * <p>当你需要把一个文件的所有内容读取为字符串，可以使用{@link org.itxtech.nemisys.utils.Utils#readFile}函数，
     * 来从{@code InputStream}读取所有内容为字符串。例如：<br>
     * When you need to read the whole file content as a String, you can use {@link org.itxtech.nemisys.utils.Utils#readFile}
     ...
     * <p>
     * <p>如果需要替换已存在的资源文件，建议使用{@link org.itxtech.nemisys.plugin.Plugin#saveResource(String, boolean)}<br>
     * If you need to REPLACE an existing resource file, it's recommended
     * to use {@link org.itxtech.nemisys.plugin.Plugin#saveResource(String, boolean)}.</p>
     *
     ...
     * @see org.itxtech.nemisys.plugin.Plugin#saveDefaultConfig
     * @see org.itxtech.nemisys.plugin.Plugin#saveResource(String, boolean)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * which is normally named 'resources' and placed in plugin jar file, and copy it into data folder.</p>
     * <p>
     * <p>如果需要保存默认的资源文件，建议使用{@link org.itxtech.nemisys.plugin.Plugin#saveResource(String)}<br>
     * If you need to SAVE DEFAULT resource file, it's recommended
     * to use {@link org.itxtech.nemisys.plugin.Plugin#saveResource(String)}.</p>
     *
     * @param filename 要保存的资源文件名字。<br>The name of the resource file to save.
     * @param replace  是否替换目标文件。<br>if true, Nukkit will replace the target resource file.
     * @return 保存是否成功。<br>true if the saving action is successful.
     * @see org.itxtech.nemisys.plugin.Plugin#saveResource(String)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    ...
    /**
     * 返回这个Nukkit插件配置文件的{@link org.itxtech.nemisys.utils.Config}对象。<br>
     * The config file this Nukkit plugin as a {@link org.itxtech.nemisys.utils.Config} object.
     * <p>
     ...
     * @see org.itxtech.nemisys.plugin.Plugin#getDataFolder
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Config getConfig();
     ...
     *
     * @see org.itxtech.nemisys.plugin.Plugin#getDataFolder
     * @see org.itxtech.nemisys.plugin.Plugin#saveResource
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    ...
    /**
     * 返回运行这个插件的服务器的{@link org.itxtech.nemisys.Server}对象。<br>
     * Gets the server which is running this plugin, and returns as a {@link org.itxtech.nemisys.Server} object.
     *
     * @see org.itxtech.nemisys.Server
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Server getServer();
     ...
     *
     * @see org.itxtech.nemisys.plugin.Plugin#getDescription
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    String getName();

    /**
     * 返回这个插件的日志记录器为{@link org.itxtech.nemisys.plugin.PluginLogger}对象。<br>
     * Returns the logger of this plugin as a {@link org.itxtech.nemisys.plugin.PluginLogger} object.
     * <p>
     * <p>使用日志记录器，你可以在控制台和日志文件输出信息。<br>
     * You can use a plugin logger to output messages to the console and log file.</p>
     *
     * @see org.itxtech.nemisys.plugin.PluginLogger
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    PluginLogger getLogger();

    /**
     * 返回这个插件的加载器为{@link org.itxtech.nemisys.plugin.PluginLoader}对象。<br>
     * Returns the loader of this plugin as a {@link org.itxtech.nemisys.plugin.PluginLoader} object.
     *
     * @see org.itxtech.nemisys.plugin.PluginLoader
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
